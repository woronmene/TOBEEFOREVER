...
const App = () => {
  ...
  return (
    <>
      ...
      >
        {/* Navigation bar area */}
        <nav className="container flex fixed top-10 right-0 left-0 w-full sm:pl-10 md:pl-20 z-20">
          {/* Gift btn */}
            ...
            <Giftbutton
              ...
              message={
                <>
                  ...
                  give a monetary gift then use this account <br />
                  <span className="font-[800] text-green-600">
                    0554708446 - AYENI TOMIWA DAVID - GTB
                  </span>
                </>
              }
            />
      ...
      <main className="overflow-hidden">
        ...
        />
        {/*Empthy space */}
        <section className="min-h-[100px] md:min-h-[250px] h-auto w-full bg-[#F9F6ED] "></section>
        {/* The bride section */}
        <FadeInSection
          ref={brideSectionRef}
          delay={0.4}
            ...
            <>
              <div className="container flex-1 flex flex-col bg-[#3D4E3C] md:bg-inherit rounded-[10px]">
                ...
                <div className="flex-1 md:flex md:justify-evenly md:items-center md:gap-20 md:flex-wrap space-y-10 px-10 pb-10">
                  <Eventbox
                    iconUrl={bride_price_icon}
                    time="12:00 PM"
                    event="Paying of bride price"
                  />
                  <Eventbox
                    iconUrl={reception_icon}
                    time="2:00 PM"
                    event="Reception follows"
                  />
                  <Eventbox
              ...
              >
                ...
                <span className="flex-1 flex justify-center items-center">
                  <p className="max-w-[1100px] text-[16px] md:text-[24px] text-[#808080] text-center whitespace-normal text-wrap px-10 pb-10">
                    ...
                    stronger with time and distance. Even in a long distance
                    relationship we have been constant and always present in
                    each others lives. The most incredible love that we have
                    found and accepted humbly as a gift from Jah.
                  </p>
                </span>
              </div>
            </>
